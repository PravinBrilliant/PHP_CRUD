...
if (isset($_POST['submit'])) {
	...
	// $dup=mysqli_query($conn, "select * from crud where email='$email'");
...
// {
// mysqli_query($conn,"insert into crud (name, email, mobile) values ('$name', '$email', '$mobile')");
// }
     $qry="insert into crud values(null,'$name','$email','$mobile')";
